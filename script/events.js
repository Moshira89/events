...
document.querySelector(".panther").onclick = (event) => 
    console.log(event.target.tagName)
//window.onclick = event => console.log(event.target)
 document.querySelector(".penguin").onclick = (event) => 
...
animalTabs.forEach(tab =>
    tab.addEventListener("click", () =>
        bestAnimal(tab.textContent)))
document.querySelector("footer p span").addEventListener("click", () =>
    console.log("Span"))
document.querySelector("footer").addEventListener("click", () =>
    console.log("Footer"), true)
document.querySelector("footer p").addEventListener("click", () =>
    console.log("Paragraph"), true)
